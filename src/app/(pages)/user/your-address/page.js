...
const page =  () => {
  ...
  return (
    <div className="mt-40  max-lg:mt-24 mx-auto w-3/4">
      ...
      <Link href="/address/add-new-address" className="flex flex-col w-[16rem]  items-center rounded-sm cursor-pointer justify-center text-center border-dashed border-2 border-gray-500">
