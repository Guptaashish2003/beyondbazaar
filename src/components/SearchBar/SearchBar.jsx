  ...
  return (
    ...
    {hide?<div className='bg-blor'></div>:""}
          <div className={`input-box z-10 ${hide?"mobile-search open !ml-0 !mt-5 !mb-2 ":""}`}  >
            <InputBtn ref={inputRef} name='search' onChange={onTextChange} onKeyDown={keyboardSearch} type="text" placeholder="Search..." className='relative y outline-none border-none  w-full  rounded-md text-xl font-bold  border  border-gray-200 focus:border-gray-400 !bg-transparent'/>
