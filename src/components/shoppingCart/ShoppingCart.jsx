...
const ShoppingCart = () => {
  ...
  <div
    className="w-full h-full   dark:bg-gray-900  top-0  overflow-x-hidden "
    id="chec-div"
  >
    {/*- more free and premium Tailwind CSS components at https://tailwinduikit.com/ -*/}
    <div
      className="w-full  z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition  duration-700"
      id="checkout"
    >
      <div
      ...
      >
        <div
          className="lg:w-full md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white dark:bg-gray-800 overflow-y-hidden overflow-x-hidden lg:h-screen h-auto"
          id="scroll"
        >
          <div
        ...
        <div className="lg:w-96 md:w-8/12 w-full bg-gray-100 dark:bg-gray-900 m-4 h-11/20">
          <div className="flex flex-col lg:h-11/90 h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
            <div>
