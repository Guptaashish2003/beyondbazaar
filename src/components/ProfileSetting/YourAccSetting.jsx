...
const YourAccSetting = ({img,title,description}) => {
  return (
    <div className='w-[31%] max-sm:w-[45%] border-solid border-3  active:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 border-gray-400 cursor-pointer rounded-sm ring-offset-2 ring-2 ring-gray-500  hover:text-black'>
